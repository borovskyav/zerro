...
export const en: typeof ru = {
  ...
  analytics: {
    ...
    netWorth: {
      ...
      fundsOutOfBalance: 'Funds out of Balance',
      fundsSaving: 'Safety Reserves',
      realAssets: 'Real Assets',
      investments: 'Investments',
      total: 'Total',
  ...
  settings: {
    ...
    useAccountCategorization: "Account categorization",
    useAccountCategorizationDescription: "Categorize accounts by savings and investments",
